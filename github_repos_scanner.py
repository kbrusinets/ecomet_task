...
создает оставшиеся N-1 аналогичных тасков, по одному на оставшуюся страницу коммитов в репе, и кладет их в очередь.
...
Как только вся информация для репозитория собрана, он сохраняется в БД - _check_repo_finished.
"""
